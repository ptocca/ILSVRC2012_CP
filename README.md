...
Please read the `Notes` tab in the app for additional information.

The demo can be run on BinderHub (click on the badge below).    
NOTE: It can take a few minutes to start, so be patient!
 
[![Binder](https://mybinder.org/badge_logo.svg)](https://mybinder.org/v2/gh/ptocca/ILSVRC2012_CP/master?urlpath=/apps/ILSRVC_CP-Demo.ipynb)
